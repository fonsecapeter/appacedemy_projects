...
/***/ function(module, exports, __webpack_require__) {
	...
	var MyComponent = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(Game, { board: new Minesweeper.Board(9, 9) });
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Board = __webpack_require__(169);
	...
	var Game = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(Board, { updateGame: this.updateGame, board: this.props.board });
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Board = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var grid = this.props.board.grid.map(function (subArr, idx1) {
	      var tiles = [];
	      var that = _this;
	      subArr.forEach(function (tile, idx2) {
	        tiles.push(React.createElement(Tile, { key: idx1 + '.' + idx2,
